...
storiesOf("Button", module)
  ...
  .add("Disabled", () => (
    <Button disabled onClick={action("button-clicked-2")}>
      Disabled
    </Button>
  ));
...
storiesOf("DayListItem",module)
  ...
  .add("Unselected", ()=><DayListItem name="Monday" spots={5} setDay={action('setDay')} />)
...
storiesOf("InterviewerList", module)
  ...
  storiesOf("Appointment", module)
    ...
    .add("Show", () => (
      <Show student={'Lydia Miller-Jones'}  interviewer={interviewers[0]} 
    ...
    .add("Form with Edit", () => (
      <Form name={'Jay'} value={1} interviewers={interviewers} onSave={action('onSave')} onCancel={action('onCancel')}
      />
    ))
    .add("Form with Create", () => (
